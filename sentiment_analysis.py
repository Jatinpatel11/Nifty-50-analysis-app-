...
class SentimentAnalysis:
    def __init__(self, news_path='data/news/dummy_news.csv', tweets_path='data/news/dummy_twitter.csv'):
        ...
        # Add financial and stock market specific terms to the sentiment analyzer
        self._add_financial_terms_to_lexicon()
    ...
    def _add_financial_terms_to_lexicon(self):
        """
        Add financial and stock market specific terms to the VADER lexicon
        """
        print("Adding financial terms to sentiment lexicon...")
    ...
    def analyze_news_sentiment(self):
        ...
        news_sentiment['sentiment_scores'] = news_sentiment['combined_text'].apply(lambda x: self.sia.polarity_scores(x) if isinstance(x, str) else None)
    ...
    def analyze_twitter_sentiment(self):
        ...
        # Apply VADER sentiment analysis
        twitter_sentiment['sentiment_scores'] = twitter_sentiment['text'].apply(lambda x: self.sia.polarity_scores(x) if isinstance(x, str) else None)
