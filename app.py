...
# Function to create price analysis charts
def create_price_charts(price_data):
...
# Function to create sentiment analysis charts
def create_sentiment_charts(news_sentiment, twitter_sentiment, overall_sentiment):
...
# Function to create prediction charts
def create_prediction_charts(price_data, future_predictions, model_comparison):
...
def main():
    ...
    # Price Analysis page
        ...
        fig = create_price_charts(filtered_data)
        st.plotly_chart(fig, use_container_width=True)
    ...
    # Sentiment Analysis page
        ...
        fig1, fig2, fig3 = create_sentiment_charts(
            data['news_sentiment'],
    ...
    # Price Prediction page
        ...
        fig1, fig2, fig3 = create_prediction_charts(
            data['price_data'],
